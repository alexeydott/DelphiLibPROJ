...
{$ELSE}
	...
	procedure pj_ctx_alloc; external;
	procedure pj_ctx_free; external;
	...
	procedure pj_init_plus_ctx; external;
...
{$ENDREGION}
	...
	function _pj_init_plus(const def: PAnsiChar): Pointer; cdecl; external name NAME_PREFIX+'pj_init_plus';
	function _pj_is_latlong(p: Pointer): integer; cdecl; external name NAME_PREFIX+'pj_is_latlong';
	function _pj_is_geocent(p: Pointer): integer; cdecl; external name NAME_PREFIX+'pj_is_geocent';
	function _pj_latlong_from_proj(p: Pointer): Pointer; cdecl; external name NAME_PREFIX+'pj_latlong_from_proj';
	procedure _pj_free(p: Pointer); cdecl; external name NAME_PREFIX+'pj_free';
	function _pj_transform(src,dst: Pointer; point_count,point_offset: integer; x,y,z: PDouble): Integer; cdecl; external name NAME_PREFIX+'pj_transform';
	function _pj_get_def(p: Pointer): Pointer; cdecl; external name NAME_PREFIX+'pj_get_def';
	function _pj_strerrno(errno: Integer): Pointer; cdecl; external name NAME_PREFIX+'pj_strerrno';
  function _pj_get_ctx(p: Pointer): Pointer; cdecl; external name NAME_PREFIX+'pj_get_ctx';
	procedure _pj_ctx_set_logger(ctx: pointer; logger: Pointer); cdecl; external name NAME_PREFIX+'pj_ctx_set_logger';
	function _pj_get_release(): Pointer; cdecl; external name NAME_PREFIX+'pj_get_release';
	function _pj_ctx_fgets(ctx: pointer; line: PByte; Size: Integer; _file: PInteger): PByte; cdecl; external name NAME_PREFIX+'pj_ctx_fgets';
	procedure _pj_log(ctx: pointer; level: Integer; fmt: PAnsiChar); cdecl; external name NAME_PREFIX+'pj_log'; varargs;
	procedure _pj_get_spheroid_defn(p: pointer; major_axis: PDouble; eccentricity_squared: PDouble); cdecl; external name NAME_PREFIX+'pj_get_spheroid_defn';
	function _pj_get_errno_ref(): PInteger; cdecl; external name NAME_PREFIX+'pj_get_errno_ref';

	function _proj_list_operations(): Pointer; cdecl; external name NAME_PREFIX+'proj_list_operations';
{$ENDREGION 'Api calls'}
