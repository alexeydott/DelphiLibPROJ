...
function _asctime(tptr: ptm): PAnsiChar; cdecl;
{$EXTERNALSYM _wasctime}
function _wasctime(tptr: ptm): PWideChar; cdecl;
{$EXTERNALSYM _asin}
...
{$EXTERNALSYM _atof}
function _atof(const s: PAnsiChar): Double; cdecl;
{$EXTERNALSYM _atoi}
function _atoi(const str: PAnsiChar): Integer; cdecl;
{$EXTERNALSYM _atol}
function _atol(const s: PAnsiChar): Longint; cdecl;
...
{$EXTERNALSYM _ctime}
function _ctime(tod: ptime_t): PAnsiChar; cdecl;
...
function _exp2(x: single): single; overload; cdecl;
function _exp2(x: Double): Double; overload; cdecl;
function _exp2(x: Extended): Extended; overload; cdecl;

{$EXTERNALSYM _errno}
function ___errno: PInteger; cdecl;
{$EXTERNALSYM _errno}
function __errno: PInteger; cdecl;
...
{$EXTERNALSYM _fgets}
function _fgets(s: PAnsiChar; n: Integer; stream: PFILE): PAnsiChar; cdecl;
{$EXTERNALSYM _fgetwc}
...
function _wfopen(filename, mode: PWideChar): PFILE; cdecl;

{$EXTERNALSYM _fprintf}
function _fprintf(stream: PFILE; const format: PAnsiChar): Integer; cdecl; varargs;
{$EXTERNALSYM _fputc}
...
function _freopen(const filename, mode: PAnsiChar; stream: PFILE): PFILE; cdecl;
{$EXTERNALSYM _frexp}
function _frexp(x: Double; pexp: PInteger): Double; cdecl;
{$EXTERNALSYM _fscanf}
function _fscanf(stream: PFILE; const format: PAnsiChar): Integer; cdecl; varargs;
{$EXTERNALSYM _fseek}
...
{$EXTERNALSYM _gets}
function _gets(s: PAnsiChar): PAnsiChar; cdecl;
{$EXTERNALSYM _gmtime}
...
{$EXTERNALSYM _mblen}
function _mblen(const s: Pointer; n: size_t): Integer; cdecl;
{$EXTERNALSYM _mbstowcs}
function _mbstowcs(wcs: pwchar_t; const s: Pointer; n: size_t): size_t; cdecl;
{$EXTERNALSYM _mbtowc}
function _mbtowc(pwc: pwchar_t; const s: Pointer; n: size_t): Integer; cdecl;
{$EXTERNALSYM _memchr}
...
{$EXTERNALSYM _remove}
function _remove(const filename: PAnsiChar): Integer; cdecl;
{$EXTERNALSYM _rename}
function _rename(const old, new: PAnsiChar): Integer; cdecl;
{$EXTERNALSYM _rewind}
procedure _rewind(stream: PFILE); cdecl;
{$EXTERNALSYM _scanf}
function _scanf(const format: PAnsiChar): Integer; cdecl; varargs;
{$EXTERNALSYM _setbuf}
procedure _setbuf(stream: PFILE; buf: PAnsiChar); cdecl;
{$EXTERNALSYM _setlocale}
function _setlocale(category: Integer; const locname: PAnsiChar): PAnsiChar; cdecl;
{$EXTERNALSYM _setvbuf}
function _setvbuf(stream: PFILE; buf: PAnsiChar; mode: Integer;
...
{$EXTERNALSYM _strchr}
function _strchr(const s: PAnsiChar; c: Integer): PAnsiChar; cdecl;
{$EXTERNALSYM _strcmp}
function _strcmp(const s1, s2: PAnsiChar): Integer; cdecl;
{$EXTERNALSYM _strcoll}
function _strcoll(const s1, s2: PAnsiChar): Integer; cdecl;
{$EXTERNALSYM _strcpy}
function _strcpy(s1: PAnsiChar; const s2: PAnsiChar): PAnsiChar; cdecl;
{$EXTERNALSYM _strcspn}
function _strcspn(const s1, s2: PAnsiChar): size_t; cdecl;
{$EXTERNALSYM _strerror}
function _strerror(errcode: Integer): PAnsiChar; cdecl;
{$EXTERNALSYM _strftime}
function _strftime(s: PAnsiChar; n: size_t; const format: PAnsiChar;
...
function _strpbrk(const s1, s2: PAnsiChar): PAnsiChar; cdecl;
{$EXTERNALSYM _strrchr}
function _strrchr(const s: PAnsiChar; c: Integer): PAnsiChar; cdecl;
{$EXTERNALSYM _strspn}
function _strspn(const s1, s2: PAnsiChar): size_t; cdecl;
{$EXTERNALSYM _strstr}
function _strstr(const s1, s2: PAnsiChar): PAnsiChar; cdecl;
{$EXTERNALSYM _strtod}
function _strtod(const s: PAnsiChar; var endptr: PAnsiChar): Double; cdecl;
{$EXTERNALSYM _strtok}
function _strtok(s1: PAnsiChar; const s2: PAnsiChar): PAnsiChar; cdecl;
{$EXTERNALSYM _strtol}
function _strtol(const s: PAnsiChar; endptr: PPChar;
  base: Integer): Longint; cdecl;
{$EXTERNALSYM _strtoul}
function _strtoul(const s: PAnsiChar; var endptr: PAnsiChar;
  base: Integer): Longword; cdecl;
{$EXTERNALSYM _strxfrm}
function _strxfrm(s1: PAnsiChar; const s2: PAnsiChar; n: size_t): size_t; cdecl;
...
{$EXTERNALSYM _system}
function _system(const s: PAnsiChar): Integer; cdecl;
{$EXTERNALSYM _tan}
...
function _vfprintf(stream: PFILE; const format: PAnsiChar;
...
function _vprintf(const format: PAnsiChar; ap: va_list): Integer; cdecl;
...
{$EXTERNALSYM _wctomb}
function _wctomb(s: PAnsiChar; wchar: wchar_t): Integer; cdecl;
...
function __lsetlocale(category: Integer; const locname: PAnsiChar): PAnsiChar; cdecl;
{$EXTERNALSYM __lstrcoll}
function __lstrcoll(const s1, s2: PAnsiChar): Integer; cdecl;
{$EXTERNALSYM __lstrxfrm}
function __lstrxfrm(s1: PAnsiChar; const s2: PAnsiChar; size: size_t): size_t; cdecl;
...
const
	...
	/// <summary>
	///   Max. argument for Exp = Ln(MaxSingle)
	/// </summary>
	MaxLnSingle = 88.72283;
	/// <summary>
	///   Min. argument for Exp = Ln(MinSingle)
	/// </summary>
	MinLnSingle = -87.33655;
	/// <summary>
	///   Min. argument for Exp = Ln(MinDouble)
	/// </summary>
	MinLnDouble = -708.3964185322641;
	/// <summary>
	///   Min. argument for Exp = Ln(MaxDouble)
	/// </summary>
	MaxLnDouble = 709.7827128933840;
	/// <summary>
	///   Min. argument for Exp = Ln(MaxExtended)
	/// </summary>
	MaxLnExtended = 11355.830259113584004;
	/// <summary>
	///   Min. argument for Exp = Ln(MinExtended)
	/// </summary>
	MinLnExtended = -11354.443964752464114;
...
function _wasctime; external msvcrtdll name 'wasctime';
...
function _exp2(x: single): single;
var
	xLn2 : single;
begin
//	Result := Exp(2 * log(x));
	xLn2 := x * Ln(2);
	if (xLn2 < MinLnSingle) or (xLn2 > MaxLnSingle) then
		begin
			_errno := ERANGE;
			Result := Infinity
		end
...
function _exp2(x: Double): Double; cdecl;
var
	xLn2 : Double;
begin
//	Result := Exp(2 * log(x));
	xLn2 := x * Ln(2);
	if (xLn2 < MinLnDouble) or (xLn2 > MaxLnDouble) then
		begin
			_errno := ERANGE;
			Result := Infinity
		end
...
function _exp2(x: Extended): Extended;
var
	xLn2 : Extended;
begin
//	Result := Exp(2 * log(x));
	xLn2 := x * Ln(2);
	if (xLn2 < MinLnExtended) or (xLn2 > MaxLnExtended) then
		begin
			_errno := ERANGE;
			Result := Infinity
		end
...
function __errno; external msvcrtdll name '__errno';
...
function _wfopen; external msvcrtdll name 'wfopen';
...
function _sqrt(x: Double): Double;
begin
	if IsNan(x) or IsInfinite(x) or (x < 0) then
		Result := Infinity
	else
		Result := Sqrt(x)
end;
...
function __huge_dble(): double; Cdecl;
//const
//	sInfinity = ansistring('infinity');
begin
//	Result := _atof(sInfinity);
	Result := MaxDouble;
end;
...
function _putwchar(c: wchar_t): wint_t;
begin
//	if not Assigned(int_putwchar) then
//	begin
//		SafeGetProcAddress(msvcrtdll, 'putwchar', @putwchar);
//	end;
